      ...
      custom_fields: [
        {
          ...
          dropdown: {
            options: [
              { label: "Grocery Tote · Small", value: "grocery-s" },
              { label: "Grocery Tote · Medium", value: "grocery-m" },
              { label: "Grocery Tote · Large", value: "grocery-l" },
              { label: "Grocery Tote · X-Large", value: "grocery-xl" },
              { label: "Canvas Tote · Small", value: "canvas-s" },
              { label: "Canvas Tote · Medium", value: "canvas-m" },
              { label: "Canvas Tote · Large", value: "canvas-l" },
