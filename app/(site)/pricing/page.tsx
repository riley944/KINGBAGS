        ...
        <div className="mx-auto max-w-3xl px-5 text-center">
          <Reveal>
            ...
            <p className="text-lg text-ink-soft leading-relaxed">
              Every price below is a fully custom, edge-to-edge printed, cut-and-sewn bag —
              not a blank with a logo — <span className="text-ink font-semibold">delivered</span>.
              Air freight, customs, and duties are in the number. One invoice, no surprises.
            </p>
          </Reveal>
        </div>
      </section>
            ...
            <div className="bg-white rounded-2.5xl border border-ink/10 overflow-hidden">
              ...
              <div className="px-8 py-6 border-t border-ink/10 grid md:grid-cols-[1fr_auto] gap-5 items-center">
                <ul className="text-[13px] text-ink-soft space-y-1.5">
                  <li>Per-bag, delivered to your door. Minimum {MIN_ORDER.toLocaleString()} bags.</li>
