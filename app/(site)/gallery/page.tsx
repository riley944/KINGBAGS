...
const CONCEPTS = [
  {
    ...
    note: "Abstract shapes wrapping every panel, with contrast lilac gussets and handles.",
    bag: "grocery-tote",
  },
  {
  ...
  },
  {
    ...
    construction: "The Grocery Tote · laminated non-woven",
    note: "Warm orange edge to edge, illustrated checkerboard on the gussets.",
    bag: "grocery-tote",
  },
  {
    slug: "casa-bonita-mercado",
    brand: "Casa Bonita Mercado",
    vertical: "Retail",
    construction: "The Grocery Tote · laminated non-woven",
    note: "Dense floral pattern across front, sides, and base with a magenta handle pop.",
    bag: "grocery-tote",
  },
  {
    slug: "olive-market",
